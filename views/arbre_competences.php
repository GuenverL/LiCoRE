<div class="panel panel-default">
    ...
    <div class="panel-group" id="arbre_competences" role="tablist" aria-multiselectable="true">
        <div class="panel panel-default">
        ...
        <div class="panel panel-default">
            ...
            <div id="arbre_competences_collapseTwo" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                <table class="table table-bordered table-hover table-condensed">
                    ...
                    <tbody>
                        <tr>
                            <td>Situer son rôle et sa mission au sein d'une organisation pour s'adapter et prendre des initiatives</td>
                            <td>17/01/2016</td>
                        </tr>
                        <tr>
                            <td>Identifier le processus de production, de diffusion et de valorisation des savoirs</td>
                            <td>12/01/2016</td>
                        </tr>
                    </tbody>
                </table>
        ...
        <div class="panel panel-default">
            ...
            <div id="arbre_competences_collapseThree" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                <table class="table table-bordered table-hover table-condensed">
                    ...
                    <tbody>
                        <tr>
                            <td>Utiliser les outils numériques de référence et les règles de sécurité informatique pour acquérir, traiter, produire et diffuser de l’information ainsi que pour collaborer en interne et en externe</td>
                            <td>11/01/2016</td>
                        </tr>
                        <tr>
                            <td>Identifier et sélectionner diverses ressources spécialisées pour documenter un sujet</td>
                            <td>05/01/2016</td>
                        </tr>
                    </tbody>
                </table>
