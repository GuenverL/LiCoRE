...
function setCompetencesVisibilite(e,t){"use strict";for(var n=0,o=e.length;o>n;++n){var i=e[n];if("setCompetencesInvisibles"===t){$("#competence-"+i.idCompetence).toggleClass("couleur-grise"),$("#competence-"+i.idCompetence).find("span.glyphicon-eye-close").remove(),$("#competence-"+i.idCompetence).find("span.glyphicon-eye-open").remove(),$("#competence-"+i.idCompetence).find("span.glyphicon-pencil").after(genererBoutonGestion(i,"setCompetencesVisibles","Rendre la compétence visible","glyphicon-eye-open couleur-bleue"));var c={idCompetence:i.idCompetence,nomCompetence:i.nomCompetence,visibilite:"setCompetencesVisibles"};$("#competence-"+i.idCompetence+"-button-visibilite").off(),$("#competence-"+i.idCompetence+"-button-visibilite").click(c,setCompetencesVisibiliteOnClick)}else $("#competence-"+i.idCompetence).toggleClass("couleur-grise"),$("#competence-"+i.idCompetence).find("span.glyphicon-eye-open").first().remove(),$("#competence-"+i.idCompetence).find("span.glyphicon-pencil").first().after(genererBoutonGestion(i,"setCompetencesInvisibles","Rendre la compétence invisible","glyphicon-eye-close couleur-bleue")),$("#competence-"+i.idCompetence+"-button-visibilite").off()}}function setCompetencesVisibiliteOnClick(e){"use strict";var t=e.data.idCompetence,n=e.data.visibilite;$.getJSON("api/competences.php",{type:n,idCompetence:t}).always(function(e){$(".tooltip").remove(),setCompetencesVisibilite(e,n),$('[data-toggle="modal"]').tooltip()})}function majButtons(e){"use strict";$buttonSelectionne.removeClass("active"),e.addClass("active"),$buttonSelectionne=e}function majArbreGestionCompetences(e,t){"use strict";var n=$(e);typeAffichageCompetences=t,$buttonSelectionne.selector!==n.selector&&(majButtons(n),$("#arbreGestionCompetences").empty(),$("#arbreGestionCompetences").hide(),$("#loader-competences").show(),$.getJSON("api/competences.php",{type:t}).always(function(e){if(""!==e.responseText){$("#arbreGestionCompetences").append('<li id="listeCompetences"><a href="#">Liste des compétences</a>'),$("#listeCompetences").append(genererListeCompetences(0,0,e,"gestionCompetences")),majArbre("#arbreGestionCompetences"),$('[data-toggle="modal"]').tooltip();for(var t=0,n=e.length;n>t;++t){var o=e[t];if(o.feuille){var i;i=o.visible||void 0===o.visible?"setCompetencesInvisibles":"setCompetencesVisibles";var c={idCompetence:o.idCompetence,nomCompetence:o.nomCompetence,visibilite:i};$("#competence-"+o.idCompetence+"-button-visibilite").click(c,setCompetencesVisibiliteOnClick)}}$("#loader-competences").hide(),$("#arbreGestionCompetences").show()}}))}function buttonSubmitGestionCompetences(e){"use strict";var t=e.data.idCompetence,n=e.data.type,o=$("#genericModal").find(".modal-body #nomCompetence").val();$.getJSON("api/competences.php",{type:n,idCompetence:t,nomCompetence:o}).always(function(e){if(e){var i=function(e){var n=$("#competence-"+t).find("ul").length,o=$("#competence-"+t).find("i").hasClass("glyphicon-chevron-down");0===n&&$("#competence-"+t).append("<ul>");for(var i=0,c=e.length;c>i;++i){var s=e[i];if(-1!==s.idCompetence){o?$("#competence-"+t).find("ul").first().append(genererLigneCompetenceGestion(s,"display-normal")):$("#competence-"+t).find("ul").first().append(genererLigneCompetenceGestion(s,"display-none"));var p;p=s.visible?"setCompetencesInvisibles":"setCompetencesVisibles";var m={idCompetence:s.idCompetence,nomCompetence:s.nomCompetence,visibilite:p};$("#competence-"+s.idCompetence+"-button-visibilite").off(),$("#competence-"+s.idCompetence+"-button-visibilite").click(m,setCompetencesVisibiliteOnClick)}}0===n&&($("#competence-"+t).append("</ul>"),actualiserBranche($("#competence-"+t)),$("#competence-"+t).find("i").removeClass("glyphicon-chevron-right"),$("#competence-"+t).find("i").addClass("glyphicon-chevron-down"))};switch(n){case"ajouterCompetence":-1!==e.idCompetence&&i([e]);break;case"ajouterPlusieursCompetences":i(e);break;case"modifierCompetence":e.retour&&($("#competence-"+t).find("span.glyphicon-plus").first().attr("data-nom-competence",o),$("#competence-"+t).find("span.glyphicon-th-list").first().attr("data-nom-competence",o),$("#competence-"+t).find("span.glyphicon-pencil").first().attr("data-nom-competence",o),$("#competence-"+t).find("span.glyphicon-eye-close").first().attr("data-nom-competence",o),$("#competence-"+t).find("span.glyphicon-eye-open").first().attr("data-nom-competence",o),$("#competence-"+t).find("span.glyphicon-remove").first().attr("data-nom-competence",o),$("#competence-"+t).find("a").first().empty(),$("#competence-"+t).find("a").first().append(o));break;case"setCompetencesInvisibles":setCompetencesVisibilite(e,"setCompetencesInvisibles");break;case"supprimerCompetence":$("#competence-"+t).remove();break;default:$.getJSON("api/competences.php",{type:typeAffichageCompetences}).always(function(e){$("#arbreGestionCompetences").empty(),$("#arbreGestionCompetences").append('<li id="listeCompetences"><a href="#">Liste des compétences</a>'),$("#listeCompetences").append(genererListeCompetences(0,0,e,"gestionCompetences")),majArbre("#arbreGestionCompetences"),$('[data-toggle="modal"]').tooltip()})}}})}var $buttonSelectionne=$("#buttonToutesCompetences"),typeAffichageCompetences="getToutesLesCompetences";$("#buttonToutesCompetences").click(function(){"use strict";majArbreGestionCompetences("#buttonToutesCompetences","getToutesLesCompetences")}),$("#buttonCompetencesVisibles").click(function(){"use strict";majArbreGestionCompetences("#buttonCompetencesVisibles","getCompetencesVisibles")}),$("#buttonCompetencesInvisibles").click(function(){"use strict";majArbreGestionCompetences("#buttonCompetencesInvisibles","getCompetencesInvisibles")});
