...
function genererListGroupItem(e,t,a,i,o,n){"use strict";var l,r,d="";return"validationCompetenceParTuteur"===a||"invalidationCompetencesUtilisateurs"===a?(l=e.idUtilisateur,r=e.prenomUtilisateur+" "+e.nomUtilisateur):(l=e.idCompetence,r=e.nomCompetence),d='<div id="list-group-item-'+l+'" class="list-group-item cursor-pointer couleur-'+t+'-bg" data-toggle="modal" ',n?(d+="validationCompetenceParTuteur"===a?'data-target="#validationUtilisateursModal"':'data-target="#genericModal"',d+=' data-type="'+a+'" data-id-competence="'+e.idCompetence+'" data-nom-competence="'+e.nomCompetence):d+='data-target="#connexionModal"',"validationCompetenceParTuteur"===a&&(d+='" data-nom-utilisateur="'+r+'" data-id-utilisateur="'+l),d+='"><div class="media"><div class="media-body">'+r,"valide"===t&&(d+='<hr class="separation-competence-valide">Validée par '+e.prenomTuteur+" "+e.nomTuteur+" le "+e.dateValidation),d+='</div><div class="media-right media-middle">',d+="validationCompetenceParTuteur"===a||"invalidationCompetencesUtilisateurs"===a?' <span id="utilisateur-':' <span id="competence-',d+=l+'" data-toggle="modal" data-placement="top" data-original-title="'+i+'" class="glyphicon cursor-pointer '+o+'" aria-hidden="true"></span></div></div>'}function buttonSubmitValidation(e){"use strict";var t,a,i=e.data.idCompetence,o=(e.data.nomCompetence,e.data.type);"accepterValidation"===o||"refuserValidation"===o?(t=e.data.idUtilisateur,a=$("#list-group-item-"+t)):a=$("#list-group-item-"+i),$(".tooltip").remove();var n=function(){a.removeAttr("data-target"),a.removeAttr("data-toggle"),a.removeAttr("data-original-title"),a.removeAttr("data-id-utilisateur"),a.removeAttr("data-nom-utilisateur"),a.removeAttr("data-id-competence"),a.removeAttr("data-nom-competence"),a.removeAttr("data-type"),a.removeAttr("title"),a.find("span.glyphicon").first().remove()};"validerCompetence"===o?($.getJSON("api/competences.php",{type:"validation",idCompetence:i,explications:$("#genericModal").find(".modal-body #explicationsValidation").val()}),a.attr("data-type","invaliderCompetenceTemporaire"),a.toggleClass("couleur-attente-bg"),a.find("span.glyphicon").first().toggleClass("glyphicon-ok"),a.find("span.glyphicon").first().toggleClass("glyphicon-hourglass"),a.find("span.glyphicon-hourglass").first().attr("data-original-title","Compétence en attente de validation")):"invaliderCompetenceTemporaire"===o?($.getJSON("api/competences.php",{type:"invalidation",idCompetence:i}),a.attr("data-type","validerCompetence"),a.toggleClass("couleur-attente-bg"),a.find("span.glyphicon").first().toggleClass("glyphicon-ok"),a.find("span.glyphicon").first().toggleClass("glyphicon-hourglass"),a.find("span.glyphicon-ok").first().attr("data-original-title","Valider la compétence")):"invaliderCompetence"===o?($.getJSON("api/competences.php",{type:"invalidation",idCompetence:i}),a.attr("data-type","validerCompetence"),a.toggleClass("couleur-valide-bg"),a.find("span.glyphicon").first().toggleClass("glyphicon-ok"),a.find("span.glyphicon").first().toggleClass("glyphicon-remove"),a.find("span.glyphicon-ok").first().attr("data-original-title","Valider la compétence")):"accepterValidation"===o?($.getJSON("api/competences.php",{type:"accepterValidation",idCompetence:i,idUtilisateur:t}),n(),a.toggleClass("couleur-attente-bg"),a.toggleClass("couleur-valide-bg")):"refuserValidation"===o&&($.getJSON("api/competences.php",{type:"refuserValidation",idCompetence:i,idUtilisateur:t,explications:$("#genericModal").find(".modal-body #validationUtilisateursModal").val()}),n(),a.toggleClass("couleur-attente-bg"),a.toggleClass("couleur-invalide-bg"),a.toggleClass("couleur-text-invalide"))}function afficherCompetence(e){"use strict";var t,a=e.data.idCompetence,i=e.data.nomCompetence,o=e.data.type;null!==$lienPrecedent&&($lienPrecedent.toggleClass("couleur-text-selection"),$lienPrecedent.toggleClass("couleur-text-lien")),$lienPrecedent=$("#competence-"+a),$lienPrecedent.toggleClass("couleur-text-lien"),$lienPrecedent.toggleClass("couleur-text-selection"),$.getJSON("api/competences.php",{type:"estConnecte"},function(e){t=e.estConnecte}),"sousCompetences"===o?$.getJSON("api/competences.php",{type:"sousCompetences",idPere:a},function(e){$("#panel-body-competences").empty(),$("#panel-body-competences").append('<div class="list-group-item heading">'+i+'</div><div id="competences-a-valider" class="list-group"></div>');for(var a=0,o=e.length;o>a;++a){var n=e[a];"attente"===n.etat?$("#competences-a-valider").append(genererListGroupItem(n,"attente","invaliderCompetenceTemporaire","Compétence en attente de validation","glyphicon-hourglass",t)):"valide"===n.etat?$("#competences-a-valider").append(genererListGroupItem(n,"valide","invaliderCompetence","Invalider la compétence","glyphicon-remove",t)):$("#competences-a-valider").append(genererListGroupItem(n,"","validerCompetence","Valider la compétence","glyphicon-ok",t))}$('[data-toggle="modal"]').tooltip()}).fail(function(e,t,a){console.error("getJSON failed, status: "+t+", error: "+a)}):$.getJSON("api/competences.php",{type:"getUtilisateursCompetence",idCompetence:a},function(e){$("#panel-body-etudiants").empty(),$("#panel-body-etudiants").append('<div class="list-group-item heading">'+i+'</div><div id="utilisateurs-a-valider" class="list-group"></div>');for(var t=0,o=e.length;o>t;++t){var n=e[t],l={idCompetence:a,nomCompetence:i,idUtilisateur:n.idUtilisateur,prenomUtilisateur:n.prenom,nomUtilisateur:n.nom};$("#utilisateurs-a-valider").append(genererListGroupItem(l,"attente","validationCompetenceParTuteur","Valider l'étudiant","glyphicon-hourglass",!0))}$('[data-toggle="modal"]').tooltip()}).fail(function(e,t,a){console.error("getJSON failed, status: "+t+", error: "+a)})}$("#validationUtilisateursModal").on("shown.bs.modal",function(e){"use strict";var t=$("#buttonAccepter"),a=$("#buttonRefuser");$(this).removeData("modal"),t.off(),a.off();var i,o=$(e.relatedTarget),n=o[0].dataset.idCompetence,l=o[0].dataset.nomCompetence,r=o[0].dataset.idUtilisateur,d=o[0].dataset.nomUtilisateur;$.getJSON("api/competences.php",{type:"getExplications",idCompetence:n,idUtilisateur:r},function(e){i=e});var s,p=$(this);i&&(s+='<div class="alert alert-info" role="alert">...</div>'),s+='<div class="form-group"><label for="explications-validation" class="control-label" id="label"></label><textarea rows="10" class="form-control" id="explicationsValidation"></textarea></div>',p.find(".modal-body #validationUtilisateursModalForm").empty(),p.find(".modal-title").text('Valider la compétence "'+l+'" pour "'+d+'"'),p.find(".modal-body #validationUtilisateursModalForm").append(s),p.find(".modal-body #label").text("En cas de refus, expliquez la raison pour que l'étudiant puisse savoir ce qu'il doit améliorer :");var c={idCompetence:n,nomCompetence:l,idUtilisateur:r,type:"accepterValidation"};t.click(c,buttonSubmitValidation);var m={idCompetence:n,nomCompetence:l,idUtilisateur:r,type:"refuserValidation"};a.click(m,buttonSubmitValidation)});var $lienPrecedent=null;
function changerNavActive(e){$("#navbar-ul").removeClass("active"),$("#navbar-"+e).addClass("active")}var competencesValidees;$(window).on("load",function(){"use strict";var e=location.search.split("action=")[1];e?"gestion-competences"===e?(changerNavActive(e),$("#arbreGestionCompetences").empty(),$("#arbreGestionCompetences").hide(),$.getJSON("api/competences.php",{type:"getToutesLesCompetences"}).always(function(e){if(""!==e.responseText){$("#arbreGestionCompetences").append('<li id="listeCompetences"><a href="#">Liste des compétences</a>'),$("#listeCompetences").append(genererListeCompetences(0,0,e,"gestionCompetences")),majArbre("#arbreGestionCompetences"),$('[data-toggle="modal"]').tooltip();for(var t=0,s=e.length;s>t;++t){var i=e[t];if(void 0!==i.visible&&!i.visible||i.feuille&&i.visible){var n;n=i.feuille&&i.visible?"setCompetencesInvisibles":"setCompetencesVisibles";var c={idCompetence:i.idCompetence,nomCompetence:i.nomCompetence,visibilite:n};$("#competence-"+i.idCompetence+"-button-visibilite").off(),$("#competence-"+i.idCompetence+"-button-visibilite").click(c,setCompetencesVisibiliteOnClick)}}}$("#loader-competences").hide(),$("#arbreGestionCompetences").show()})):"valider-competences-utilisateurs"===e&&(changerNavActive(e),$("#listeCompetences").empty(),$("#arbreValidationCompetences").hide(),$.getJSON("api/competences.php",{type:"getCompetencesValidation"}).always(function(e){$("#listeCompetences").append('<a href="#">Liste des compétences</a>'),$("#listeCompetences").append(genererListeCompetences(0,0,e,"afficherCompetences")),majArbre("#arbreValidationCompetences");for(var t=0,s=e.length;s>t;++t){var i=e[t];if(i.feuille){var n={idCompetence:i.idCompetence,nomCompetence:i.nomCompetence,type:"getUtilisateursCompetence"};$("#competence-"+i.idCompetence).find("a").first().click(n,afficherCompetence)}}$("#loader-competences").hide(),$("#arbreValidationCompetences").show()})):(changerNavActive("mes-competences"),$("#listeCompetences").empty(),$("#arbreListeCompetences").hide(),$.getJSON("api/competences.php",{type:"getCompetencesVisiblesSansFeuilles"}).always(function(e){$("#listeCompetences").append('<a href="#">Liste des compétences</a>'),$("#listeCompetences").append(genererListeCompetences(0,0,e,"afficherCompetences")),majArbre("#arbreListeCompetences");for(var t=0,s=e.length;s>t;++t){var i=e[t],n={idCompetence:i.idCompetence,nomCompetence:i.nomCompetence,type:"sousCompetences"};$("#competence-"+i.idCompetence).find("a").first().click(n,afficherCompetence)}$("#loader-competences").hide(),$("#arbreListeCompetences").show()}),$("#listeCompetencesValidees").empty(),$("#arbreListeCompetencesValidees").hide(),$.getJSON("api/competences.php",{type:"getCompetencesValides"}).always(function(e){e?(competencesValidees=e,$("#arbreListeCompetencesValidees").append('<li id="listeCompetencesValidees"><a href="#">Liste des compétences validées</a>'),$("#listeCompetencesValidees").append(genererListeCompetences(0,0,e,"afficherCompetences"))):$("#panel-body-competences-validees").append("<p>Aucunes compétences validées</p>"),majArbre("#arbreListeCompetencesValidees"),$("#loader-competences-validees").hide(),$("#arbreListeCompetencesValidees").show()}))});