window.onload=function(){var e='<?xml version = "1.0" encoding="UTF-8" standalone="yes" ?>\n<arbre>\n';$.getJSON("api/competences.php",{type:"getCompetencesValides"},function(n){for(var o=0,t=n.length;t>o;++o){var i=n[o];e+="  <competence>\n       <id>"+i.idCompetence+"</id>\n       <nom>"+i.nomCompetence+"</nom>\n       <idPere>"+i.idPereCompetence+"</idPere>\n"}e+="</arbre>"}).fail(function(e,n,o){console.error("getJSON failed, status: "+n+", error: "+o)}),document.getElementById("linkXML").onclick=function(n){this.href="data:application/xml;charset=utf-8,"+encodeURIComponent(e)},console.log(e)};
function genererBoutonGestion(e,n,t,o){"use strict";var i="";return i+="setCompetencesVisibles"===n||e.feuille&&"setCompetencesInvisibles"===n?' <span id="competence-'+e.idCompetence+'-button-visibilite" data-toggle="modal"':' <span data-toggle="modal" data-target="#genericModal" data-type="'+n+'" data-id-competence="'+e.idCompetence+'" data-nom-competence="'+e.nomCompetence+'"',i+=' data-placement="top" data-original-title="'+t+'" class="glyphicon cursor-pointer '+o+'" aria-hidden="true"></span>'}function genererLigneCompetenceGestion(e,n){"use strict";var t="";return t+='<li id="competence-'+e.idCompetence+'"',void 0===e.visible||e.visible||(t+=' class="couleur-grise"'),t+="display-none"===n?' style="display: none;">':">",t+='<a href="#">'+e.nomCompetence+"</a>",t+=genererBoutonGestion(e,"ajouterCompetence","Ajouter une compétence","glyphicon-plus couleur-verte"),t+=genererBoutonGestion(e,"ajouterPlusieursCompetences","Ajouter plusieurs compétences","glyphicon-th-list couleur-verte"),t+=genererBoutonGestion(e,"modifierCompetence","Modifier une compétence","glyphicon-pencil couleur-jaune"),t+=e.visible||void 0===e.visible?genererBoutonGestion(e,"setCompetencesInvisibles","Rendre la compétence invisible","glyphicon-eye-close couleur-bleue"):genererBoutonGestion(e,"setCompetencesVisibles","Rendre la compétence visible","glyphicon-eye-open couleur-bleue"),t+=genererBoutonGestion(e,"supprimerCompetence","Supprimer une compétence","glyphicon-remove couleur-rouge")}function genererListeCompetences(e,n,t,o){"use strict";var i="",c=0;n||c||(i+="\n<ul>\n");for(var r=0,s=t.length;s>r;++r){var l=t[r];if(e===l.idPereCompetence){if(n>c&&(i+="\n<ul>\n"),"gestionCompetences"===o){var p={idCompetence:l.idCompetence,nomCompetence:l.nomCompetence,visible:l.visible,feuille:l.feuille};i+=genererLigneCompetenceGestion(p,"display-normal")}else i+='<li id="competence-'+l.idCompetence+'"',i+=l.valide?' class="text-validated">':' class="text-default">',i+='<a href="#">'+l.nomCompetence+"</a>";c=n,i+=genererListeCompetences(l.idCompetence,n+1,t,o)}}return i+=c===n&&0!==c?"</ul>\n</li>\n":c===n?"</ul>\n":"</li>\n"}function majArbre(e){"use strict";$(e).each(function(){$(this).treeview()})}
...
function genererListGroupItem(e,t,i,a,n){"use strict";var o,l,r="";return"validationCompetenceParTuteur"===i||"invalidationCompetencesUtilisateurs"===i?(o=e.idUtilisateur,l=e.prenomUtilisateur+" "+e.nomUtilisateur):(o=e.idCompetence,l=e.nomCompetence),r='<div id="list-group-item-'+o+'" class="list-group-item cursor-pointer couleur-'+t+'-bg" data-toggle="modal" data-target="#genericModal" data-type="'+i+'" data-id-competence="'+e.idCompetence+'" data-nom-competence="'+e.nomCompetence,"validationCompetenceParTuteur"===i&&(r+='" data-nom-utilisateur="'+l+'" data-id-utilisateur="'+o),r+='"><div class="media"><div class="media-body">'+l+'</div><div class="media-right media-middle">',r+="validationCompetenceParTuteur"===i||"invalidationCompetencesUtilisateurs"===i?' <span id="utilisateur-':' <span id="competence-',r+=o+'" data-toggle="modal" data-placement="top" data-original-title="'+a+'" class="glyphicon cursor-pointer '+n+'" aria-hidden="true"></span></div></div></div>'}function buttonSubmitValidation(e){"use strict";var t,i,a=e.data.idCompetence,n=(e.data.nomCompetence,e.data.type);"validationCompetenceParTuteur"===n||"invalidationCompetencesUtilisateurs"===n?(t=e.data.idUtilisateur,i=$("#list-group-item-"+t)):i=$("#list-group-item-"+a),$(".tooltip").remove(),"validationCompetenceParTuteur"!==n&&"invalidationCompetencesUtilisateurs"!==n||(i.toggleClass("couleur-verte-bg"),i.toggleClass("couleur-jaune-bg"),i.find("span.glyphicon").first().toggleClass("glyphicon-remove"),i.find("span.glyphicon").first().toggleClass("glyphicon-hourglass")),"validerCompetence"===n?($.getJSON("api/competences.php",{type:"validation",idCompetence:a}),i.attr("data-type","invaliderCompetenceTemporaire"),i.toggleClass("couleur-jaune-bg"),i.find("span.glyphicon").first().toggleClass("glyphicon-ok"),i.find("span.glyphicon").first().toggleClass("glyphicon-hourglass"),i.find("span.glyphicon-hourglass").first().attr("data-original-title","Compétence en attente de validation")):"invaliderCompetenceTemporaire"===n?($.getJSON("api/competences.php",{type:"invalidation",idCompetence:a}),i.attr("data-type","validerCompetence"),i.toggleClass("couleur-jaune-bg"),i.find("span.glyphicon").first().toggleClass("glyphicon-ok"),i.find("span.glyphicon").first().toggleClass("glyphicon-hourglass"),i.find("span.glyphicon-ok").first().attr("data-original-title","Valider la compétence")):"invaliderCompetence"===n?($.getJSON("api/competences.php",{type:"invalidation",idCompetence:a}),i.attr("data-type","validerCompetence"),i.toggleClass("couleur-verte-bg"),i.find("span.glyphicon").first().toggleClass("glyphicon-ok"),i.find("span.glyphicon").first().toggleClass("glyphicon-remove"),i.find("span.glyphicon-ok").first().attr("data-original-title","Valider la compétence")):"validationCompetenceParTuteur"===n?($.getJSON("api/competences.php",{type:"validationCompetenceParTuteur",idCompetence:a,idUtilisateur:t}),i.attr("data-type","invalidationCompetencesUtilisateurs"),i.find("span.glyphicon-remove").first().attr("data-original-title","Invalider l'étudiant")):"invalidationCompetencesUtilisateurs"===n&&($.getJSON("api/competences.php",{type:"invalidationCompetencesUtilisateurs",idCompetence:a,idUtilisateur:t}),i.attr("data-type","validationCompetenceParTuteur"),i.find("span.glyphicon-hourglass").first().attr("data-original-title","Valider l'étudiant"))}function afficherCompetence(e){"use strict";var t=e.data.idCompetence,i=e.data.nomCompetence,a=e.data.type;null!==$lienPrecedent&&($lienPrecedent.toggleClass("text-selected"),$lienPrecedent.toggleClass("text-default")),$lienPrecedent=$("#competence-"+t),$lienPrecedent.toggleClass("text-default"),$lienPrecedent.toggleClass("text-selected"),"sousCompetences"===a?$.getJSON("api/competences.php",{type:"sousCompetences",idPere:t},function(e){$("#panel-body-competences").empty(),$("#panel-body-competences").append('<div class="list-group-item heading">'+i+'</div><div id="competences-a-valider" class="list-group"></div>');for(var t=0,a=e.length;a>t;++t){var n=e[t];"attente"===n.etat?$("#competences-a-valider").append(genererListGroupItem(n,"jaune","invaliderCompetenceTemporaire","Compétence en attente de validation","glyphicon-hourglass")):"valide"===n.etat?$("#competences-a-valider").append(genererListGroupItem(n,"verte","invaliderCompetence","Invalider la compétence","glyphicon-remove")):$("#competences-a-valider").append(genererListGroupItem(n,"blanc","validerCompetence","Valider la compétence","glyphicon-ok"))}$('[data-toggle="modal"]').tooltip()}).fail(function(e,t,i){console.error("getJSON failed, status: "+t+", error: "+i)}):$.getJSON("api/competences.php",{type:"getUtilisateursCompetence",idCompetence:t},function(e){$("#panel-body-etudiants").empty(),$("#panel-body-etudiants").append('<div class="list-group-item heading">'+i+'</div><div id="utilisateurs-a-valider" class="list-group"></div>');for(var a=0,n=e.length;n>a;++a){var o=e[a],l={idCompetence:t,nomCompetence:i,idUtilisateur:o.idUtilisateur,prenomUtilisateur:o.prenom,nomUtilisateur:o.nom};$("#utilisateurs-a-valider").append(genererListGroupItem(l,"jaune","validationCompetenceParTuteur","Valider l'étudiant","glyphicon-hourglass"))}$('[data-toggle="modal"]').tooltip()}).fail(function(e,t,i){console.error("getJSON failed, status: "+t+", error: "+i)})}var $lienPrecedent=null;
