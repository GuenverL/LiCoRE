function exportArbre(){for(var e='<?xml version = "1.0" encoding="UTF-8" standalone="yes" ?>\n<arbre>\n',n=0,o=competencesValidees.length;o>n;++n){var c=competencesValidees[n];e+="  <competence>\n       <id>"+c.idCompetence+"</id>\n       <nom>"+c.nomCompetence+"</nom>\n       <idPere>"+c.idPereCompetence+"</idPere>\n"}e+="</arbre>",$("#linkXML").onclick=function(){this.href="data:application/xml;charset=utf-8,"+encodeURIComponent(e)}}
